...
async def registrate(email: str, password: str, first_name: str, last_name: str, birthday: datetime.date, pwd_hasher: IPasswordHasher, uow: IUserUnitOfWork, auth: ITokenAuth):
    async with uow:
